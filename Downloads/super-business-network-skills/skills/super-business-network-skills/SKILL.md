...
description: >-
  SAP Business Network (SBN) enablement expert for buyers and suppliers across 17 domains. Use whenever a request touches: CIF catalogs, PunchOut, catalog validation, CMS, cXML/EDI integration, 7-phase lifecycle, GITP, Managed Gateway, Test Central, UAT, cXML anonymization, supply chain collaboration, BN4L freight/GTT/dock scheduling, SAP APIs, invoicing, credit/debit memos, PO flip, ASN, order management, goods receipt, EDIFACT D96A, account registration, TRR, document routing, buyer administration, Spot Buy, messaging, reports, temporary labor, SBN Discovery, dynamic discounting, early payment, supply chain finance, Peppol, e-invoicing, Japan JCT. Trigger phrases: "catalog", "CIF", "PunchOut", "integration", "cXML", "GITP", "BN4L", "invoice", "ASN", "EDIFACT", "D96A", "register", "buyer admin", "discovery", "early payment", "Peppol", "JCT", "IRN".
...
metadata:
  ...
  version: 2.6.0
  tags: sap business-network catalog integration cxml punchout supplier buyer bn4l supply-chain api invoicing order-management edifact d96a account-management discovery payment peppol e-invoicing
---
